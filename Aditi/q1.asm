...
#	modularize i.e. create functions for upper2lower() and lower2upper()
#(done)	handle case if already upper then don't change -> check asci range. If range of upper then don't change.
################# Data segment #####################
	.data
